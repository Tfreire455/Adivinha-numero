const minNumberElement = document.querySelector('#minNumber'),
    maxNumberElement = document.querySelector('#maxNumber'),
    guessesRemainingNumberElement = document.querySelector('#guessesRemaining'),
    userNumberElement = document.querySelector('#userNumber'),
    checkedButtonElement = document.querySelector('#checked'),
